<script lang="ts">
	...
	export let worldSize: { width: number; height: number; depth: number } = {
		width: 20,
		height: 10,
		depth: 20,
	};
...
{#if isOpen}
	...
	>
		<div class="modal-content">
			<button class="close-button" on:click={closeModal} aria-label="Schließen"> × </button>
			...
			<form on:submit|preventDefault={handleSubmit}>
				...
				<div class="form-row">
					<div class="form-group">
						...
						<select id="difficulty" bind:value={difficulty} disabled={isLoading || !isLoggedIn}>
					...
					<div class="form-group checkbox-group">
						<label class="checkbox-label">
							<input type="checkbox" bind:checked={isPublic} disabled={isLoading || !isLoggedIn} />
				...
				<button type="submit" class="save-button" disabled={isLoading || !isLoggedIn}>

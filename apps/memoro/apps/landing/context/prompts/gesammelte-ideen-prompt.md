...
```json
{
	"de": "Gesammelte Ideen & Vorschläge",
	"en": "Collected Ideas & Suggestions",
	"it": "Idee e Suggerimenti Raccolti",
	"fr": "Idées et Suggestions Collectées",
	"es": "Ideas y Sugerencias Recopiladas"
}
```
...
```json
{
	"de": "Listet alle im Gespräch geäusserten neuen Ideen, Brainstorming-Punkte oder konkreten Vorschläge auf.",
	"en": "Lists all new ideas, brainstorming points or concrete suggestions expressed in the conversation.",
	"it": "Elenca tutte le nuove idee, punti di brainstorming o suggerimenti concreti espressi nella conversazione.",
	"fr": "Liste toutes les nouvelles idées, points de brainstorming ou suggestions concrètes exprimés dans la conversation.",

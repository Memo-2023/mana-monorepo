...
Roland is the financial architect behind Memoro's sustainable growth. As CFO, he combines the agility of a startup veteran with the precision of Swiss clockwork.

## From Startup Ecosystem to Memoro

With a background in Business Informatics (ETH Zurich) and an MBA from INSEAD, Roland started his career at McKinsey, specializing in tech startups. After stints as Finance Lead at two successful SaaS unicorns (one of which was his own startup that he co-founded and successfully exited), he brings to Memoro the perfect blend of experience and innovation spirit.

"At Memoro, I found what I've always been looking for: A product with real impact, a team with vision, and the chance to build sustainable growth the right way from the start."

## The Philosophy of Transparent Finance
...
4. **People over Profits**: Long-term value over short-term gains
...
- **Emma**: Customer success metrics and retention

## Achievements and Milestones

- **Series A Funding**: €15M at top conditions
- **Burn Rate Optimization**: 40% reduction with 2x growth
- **Team Equity**: 100% employee participation implemented
- **Sustainability Certification**: B-Corp status targeted

## Tools & Methods

- **Tech Stack**: Modern finance tools (Pleo, Personio, ChartMogul)
- **Reporting**: Automated dashboards, no Excel hell
- **Planning**: Rolling forecasts instead of rigid budgets
- **Analysis**: Cohort analyses and predictive modeling
...
- **Podcast**: "The Sustainable Startup" - weekly insights
- **Volunteering**: Financial literacy for youth

## His Vision

"Memoro should prove that you can run a tech company sustainably, transparently, and humanely. We're not just building a profitable company - we're creating a model for the future. When our numbers are right AND our team is happy, then we're doing everything right."

With his unique combination of startup mentality, financial expertise, and human focus, Roland makes Memoro a financially healthy company that grows sustainably while never losing sight of its values.
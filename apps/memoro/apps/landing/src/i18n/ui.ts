...
export const ui: UI = {
	de: {
		...
		'features.description':
			'Entdecke die vielfältigen Möglichkeiten und Features unserer modernen Plattform.',

		// Blueprints page
		'blueprints.title': 'Verfügbare Vorlagen',
		'blueprints.description':
			'Entdecke unsere verschiedenen Vorlagen für unterschiedliche Anwendungsfälle',
		...
		'guides.description':
			'Entdecken Sie unsere umfassende Sammlung an Anleitungen und lernen Sie, wie Sie die Plattform optimal nutzen.',
		...
		'testimonials.subtitle':
			'Erfahren Sie, wie Memoro Profis aus verschiedenen Branchen dabei hilft, effizienter zu arbeiten',
		...
		'howItWorks.meetings.step1.description':
			'Starten Sie die Aufnahme in Meetings oder laden Sie Audio-Dateien hoch',
		'howItWorks.meetings.step2.title': 'KI verarbeitet',
		'howItWorks.meetings.step2.description':
			'Automatische Transkription, Sprechererkennung und intelligente Strukturierung',
		'howItWorks.meetings.step3.title': 'Dokumentation fertig',
		'howItWorks.meetings.step3.description':
			'Erhalten Sie strukturierte Protokolle mit Aufgaben und Kernpunkten',
		...
		'useCases.business.description':
			'Perfekt für Meetings, Projektmanagement und Teamkommunikation',
		...
		'numbers.testimonial.quote':
			'Seit wir Memoro nutzen, sparen wir pro Woche mindestens 10 Stunden bei der Dokumentation. Die automatische Aufgabenerkennung hat unsere Projektabläufe revolutioniert.',
		...
		'cookie.description':
			'Wir verwenden Cookies, um Ihre Erfahrung auf unserer Website zu verbessern. Mit Klick auf "Alle akzeptieren" stimmen Sie der Verwendung aller Cookies zu.',
		...
		'cookie.necessary_description':
			'Diese Cookies sind für das ordnungsgemäße Funktionieren der Website unerlässlich. Sie ermöglichen grundlegende Funktionen wie die Seitennavigation und den Zugriff auf sichere Bereiche.',
		'cookie.always_active': 'Immer aktiv',
		'cookie.analytics_title': 'Analyse-Cookies',
		'cookie.analytics_description':
			'Wir verwenden PostHog für erweiterte Analysen, A/B-Tests und Feature-Flags. Umami Analytics läuft cookielos und benötigt keine Einwilligung.',
		'cookie.marketing_title': 'Marketing-Cookies',
		'cookie.marketing_description':
			'Diese Cookies können von unseren Werbepartnern gesetzt werden, um ein Profil Ihrer Interessen zu erstellen und Ihnen relevante Anzeigen auf anderen Websites zu zeigen.',
		'cookie.functional_title': 'Funktionale Cookies',
		'cookie.functional_description':
			'Diese Cookies ermöglichen erweiterte Funktionen und Personalisierung, wie das Speichern Ihrer Präferenzen.',
		'cookie.save_selected': 'Auswahl speichern',

		// SEO Meta Descriptions
		'seo.home.title': 'Memoro - KI-gestützte Gesprächsdokumentation & Notizen-App',
		'seo.home.description':
			'Memoro revolutioniert die Gesprächsdokumentation mit KI. Automatische Transkription, intelligente Zusammenfassung und Aufgabenerkennung. Jetzt kostenlos testen!',
		'seo.features.title': 'Funktionen - Memoro KI-Dokumentations-App',
		'seo.features.description':
			'Entdecke alle Funktionen von Memoro: Automatische Transkription in 24 Sprachen, KI-Zusammenfassungen, Aufgabenerkennung und vieles mehr.',
		'seo.guides.title': 'Anleitungen & Tutorials - Memoro App',
		'seo.guides.description':
			'Schritt-für-Schritt Anleitungen für Memoro. Lerne wie du Gespräche aufnimmst, transkribierst und mit KI-Unterstützung dokumentierst.',
		'seo.blog.title': 'Blog & News - Memoro Updates',
		'seo.blog.description':
			'Aktuelle News, Updates und Tipps rund um Memoro. Erfahre mehr über KI-gestützte Dokumentation und Produktivität.',
		'seo.team.title': 'Das Team hinter Memoro',
		'seo.team.description':
			'Lerne das Expertenteam hinter Memoro kennen. Spezialisten für KI, Softwareentwicklung und Datensicherheit aus Deutschland.',
		'seo.download.title': 'Memoro App Download - iOS, Android & Desktop',
		'seo.download.description':
			'Lade Memoro für dein Gerät herunter. Verfügbar für iOS, Android, Windows, macOS und Linux. Kostenlos starten!',
		'seo.contracts.title': 'Rechtliches & Datenschutz - Memoro',
		'seo.contracts.description':
			'Datenschutzerklärung, AGB und rechtliche Dokumente von Memoro. DSGVO-konform und transparent.',
		'seo.blueprints.title': 'Branchenspezifische Vorlagen - Memoro für jeden Beruf',
		'seo.blueprints.description':
			'Memoro Vorlagen für verschiedene Branchen: Handwerk, Pflege, Büro, Marketing und mehr. Optimiert für deine Arbeitsweise.',
		'seo.welcome.title': 'Willkommen bei Memoro - Registrierung erfolgreich',
		'seo.welcome.description':
			'Sie haben sich erfolgreich bei Memoro registriert. Kehren Sie jetzt zur App zurück, um sich anzumelden.',
	},
	en: {
		'nav.home': 'Home',
		...
		'features.description':
			'Discover the diverse possibilities and features of our modern platform.',
		...
		'guides.description':
			'Explore our comprehensive collection of guides and learn how to make the most of the platform.',
		...
		'testimonials.subtitle':
			'Learn how Memoro helps professionals from various industries work more efficiently',
		...
		'howItWorks.meetings.step2.description':
			'Automatic transcription, speaker recognition and intelligent structuring',
		...
		'useCases.business.title': 'Business & Management',
		'useCases.business.description':
			'Perfect for meetings, project management and team communication',
		...
		'numbers.testimonial.quote':
			'Since using Memoro, we save at least 10 hours per week on documentation. The automatic task detection has revolutionized our project workflows.',
		'numbers.testimonial.author': 'Anna Schneider',
		...
		'cookie.description':
			'We use cookies to improve your experience on our website. By clicking "Accept All", you consent to the use of all cookies.',
		...
		'cookie.analytics_description':
			'We use PostHog for advanced analytics, A/B testing and feature flags. Umami Analytics runs cookieless and requires no consent.',
		'cookie.marketing_title': 'Marketing Cookies',
		'cookie.marketing_description':
		...
		'seo.home.description':
			'Memoro revolutionizes conversation documentation with AI. Automatic transcription, intelligent summarization and task detection. Try free now!',
		'seo.features.title': 'Features - Memoro AI Documentation App',
		'seo.features.description':
			'Discover all Memoro features: Automatic transcription in 24 languages, AI summaries, task detection and much more.',
		'seo.guides.title': 'Guides & Tutorials - Memoro App',
		'seo.guides.description':
			'Step-by-step guides for Memoro. Learn how to record, transcribe and document conversations with AI support.',
		'seo.blog.title': 'Blog & News - Memoro Updates',
		'seo.blog.description':
			'Latest news, updates and tips about Memoro. Learn more about AI-powered documentation and productivity.',
		'seo.team.title': 'The Team Behind Memoro',
		'seo.team.description':
			'Meet the expert team behind Memoro. Specialists in AI, software development and data security from Germany.',
		'seo.download.title': 'Memoro App Download - iOS, Android & Desktop',
		'seo.download.description':
			'Download Memoro for your device. Available for iOS, Android, Windows, macOS and Linux. Start free!',
		'seo.contracts.title': 'Legal & Privacy - Memoro',
		'seo.contracts.description':
			'Privacy policy, terms and legal documents of Memoro. GDPR compliant and transparent.',
		'seo.blueprints.title': 'Industry-Specific Blueprints - Memoro for Every Profession',
		'seo.blueprints.description':
			'Memoro blueprints for different industries: Crafts, healthcare, office, marketing and more. Optimized for your workflow.',
		'seo.welcome.title': 'Welcome to Memoro - Registration Successful',
		'seo.welcome.description':
			'You have successfully registered with Memoro. Return to the app to sign in.',
	},
};

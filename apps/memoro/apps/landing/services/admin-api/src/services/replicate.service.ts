...
export class ReplicateService {
			...
			const output = (await this.replicate.run(
				'stability-ai/sdxl:39ed52f2a78e934b3ba6e2a89f5b1c712de7dfea535525255b1aa35c5565e08b',
				{
					input: {
						prompt,
						negative_prompt:
							'ugly, distorted, blurry, low quality, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck, (worst quality:2), (low quality:2), (normal quality:2), lowres, ((monochrome)), ((grayscale))',
						width: 1024,
						height: 1024,
						num_outputs: count,
						scheduler: 'K_EULER',
	...
	private buildPromptFromPersona(persona: PersonaData, style: string): string {
		...
		const styleModifiers = {
			portrait:
				'professional portrait photography, studio lighting, sharp focus, high quality, detailed',
			professional:
				'business attire, office environment, corporate headshot, professional photography',

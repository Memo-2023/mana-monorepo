...
<aside class="sidebar transition-all duration-300 ease-in-out" class:minimized={isMinimized}>
	<div class="flex h-full flex-col bg-menu border-r border-theme">
		...
		<div class="border-t border-theme">
			...
			>
				...
				{#if !isMinimized}
					...
					<svg
						class="h-4 w-4 transition-transform {showShortcuts ? 'rotate-180' : ''}"
						fill="none"
						stroke="currentColor"
						viewBox="0 0 24 24"
					>
			...
			{#if showShortcuts && !isMinimized}
				<div class="px-3 py-2 space-y-3 text-xs bg-content">
					<!-- Tab Navigation -->
					<div>
						<Text variant="muted" weight="semibold" class="mb-2 uppercase tracking-wide text-[10px]"
							>Tab Navigation</Text
						>
					...
					<div class="space-y-3">
						...
						<div>
							<Text
								variant="muted"
								weight="semibold"
								class="mb-2 uppercase tracking-wide text-[10px]">Tab Navigation</Text
							>
							<div class="space-y-1.5">
						...
						<div>
							<Text
								variant="muted"
								weight="semibold"
								class="mb-2 uppercase tracking-wide text-[10px]">Split Navigation</Text
							>
							<div class="space-y-1.5">
								<div class="flex items-center justify-between gap-4">
									<span class="text-theme-secondary">Focus Split 1-4</span>
						...
						<div>
							<Text
								variant="muted"
								weight="semibold"
								class="mb-2 uppercase tracking-wide text-[10px]">Mouse Shortcuts</Text
							>
							<div class="space-y-1.5">
								<div class="flex items-center justify-between gap-4">
									<span class="text-theme-secondary">Open Memo</span>
		...
		<div class="border-t border-theme p-2">
			...
			>
				...
				{:else}
					<span class="tooltip"
						>{currentTheme.effectiveMode === 'light' ? 'Dark Mode' : 'Light Mode'}</span
					>
				{/if}
			</button>

...
export default function BlueprintsPage() {
	...
	return (
		<View className="relative flex-1" style={{ backgroundColor: pageBackgroundColor }}>
			<Stack.Screen options={{ headerShown: false }} />

			{loading ? (
				<View className="flex-1 px-4 pb-20 pt-0">
				...
				<View className="flex-1 items-center justify-center p-5">
					...
					<Text className="mb-6 mt-4 text-center text-base">

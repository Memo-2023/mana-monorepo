...
function RootLayoutNav() {
  const { isAuthenticated, loading, showPasswordResetModal, setShowPasswordResetModal, setAuthModeOverride } = useAuth();
  ...
  useEffect(() => {
    console.debug('RootLayoutNav: Auth state changed - isAuthenticated:', isAuthenticated, 'loading:', loading);
    if (!loading) {
      if (isAuthenticated) {

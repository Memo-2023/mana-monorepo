...
interface PillFilterProps {
	...
	/** Pre-loaded tags from parent — skips internal fetch when provided */
	initialTags?: Tag[];
}
 ...
 */
const TagPillFilter: React.FC<PillFilterProps> = ({
	onTagSelect,
	selectedTagIds = [],
	initialTags,
}) => {
	...
	// When initialTags are provided, derive pinned tags from them
	useEffect(() => {
		if (initialTags) {
			const pinned = initialTags
				.filter((tag) => tag.is_pinned)
	...
	const fetchTags = useCallback(async () => {
		// Skip fetch when parent provides tags

...
const ManaCounter: React.FC<ManaCounterProps> = ({ count }) => {
	...
	const containerClasses =
		'flex-row items-center justify-center border rounded-full py-2 px-4 min-w-[80px] self-start';
	const iconSize = 22;
	...
	return (
		...
		>
			<ManaIcon size={iconSize} color="#0099FF" style={{ marginRight: 3, marginLeft: -6 }} />

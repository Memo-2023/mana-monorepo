	...
	if (isLoading) {
		return (
			<View style={styles.container}>
				<Text style={styles.title}>{t('audio_archive.statistics', 'Archiv-Statistiken')}</Text>
		...
		<View style={styles.container}>
			...
			<View style={styles.statsRow}>
				<View style={styles.statItem}>
					...
					<Text style={styles.statLabel}>{t('audio_archive.recordings', 'Aufnahmen')}</Text>
				</View>
				...
				<View style={styles.statItem}>
					...
					<Text style={styles.statLabel}>{t('audio_archive.duration', 'Gesamtlänge')}</Text>
				</View>
				...
				<View style={styles.statItem}>
					...
					<Text style={styles.statLabel}>{t('audio_archive.size', 'Speicherplatz')}</Text>
				</View>
			</View>

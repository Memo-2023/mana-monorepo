		...
		<View style={styles.container}>
			{isEditMode ? (
				...
				<>
					...
					{timestamp && (
						<Pressable
							onPress={() => setShowAllMetadata(!showAllMetadata)}
							...
							<View style={styles.dateContainer}>
								...
								{isPinned && (
									<>
										...
										>
											<Icon name="pin" size={14} color="#FF9500" />
										</Pressable>
									</>
								)}
							...
							{showAllMetadata && (
								<>
									...
									<View style={styles.metadataRow}>
										<Icon name="time-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
									...
									{duration !== undefined && (
										<View style={styles.metadataRow}>
											<Icon name="timer-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
									...
									{/* Views */}
									<View style={styles.metadataRow}>
										<Icon name="eye-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
									...
									{wordCount !== undefined && wordCount > 0 && (
										<View style={styles.metadataRow}>
											<Icon name="text-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
									...
									{_memoId && (
										...
										>
											<Icon name="key-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
											...
											>
												<Text
													style={[styles.metadataValue, { fontFamily: 'monospace', fontSize: 13 }]}
													numberOfLines={1}
												>
													{_memoId}
												</Text>

...
export const AudioRecorder: React.FC<AudioRecorderProps> = ({
	...
	return (
		<View className="w-full rounded-lg border border-gray-200 bg-gray-50 p-6">
			{/* Timer mit optionalem blinkenden Aufnahme-Indikator */}
			<View className="mb-4 flex items-center justify-center">
				{(isRecording || isPaused) && (
					<View className="mb-2 flex-row items-center justify-center">
						<View
							style={[styles.recordingDot, (!visible || isPaused) && styles.recordingDotInvisible]}
						/>
			...
			{/* Fehlermeldung */}
			{hasError && error && (
				<View className="mb-4 rounded border border-red-100 bg-red-50 p-2">

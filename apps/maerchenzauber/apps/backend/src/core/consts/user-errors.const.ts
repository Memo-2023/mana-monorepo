...
export const USER_ERROR_MESSAGES: Record<ErrorCategory, UserError> = {
	[ErrorCategory.RATE_LIMIT]: {
		...
		messageEN: 'Our servers are busy right now. Please wait a moment and try again.',
		retryable: true,
	},
	...
	[ErrorCategory.GENERATION_FAILED]: {
		...
		messageEN: 'Generation failed. Please try again. If the problem persists, please contact us.',
		retryable: true,
	},
	...
	[ErrorCategory.INVALID_INPUT]: {
		...
		messageEN: 'The input data is invalid. Please check your input and try again.',
		retryable: false,
	},
	...
	[ErrorCategory.SERVICE_UNAVAILABLE]: {
		...
		messageEN: 'The service is temporarily unavailable. Please try again in a few minutes.',
		retryable: true,
	},
	...
	[ErrorCategory.INSUFFICIENT_CREDITS]: {
		...
		messageEN: 'You do not have enough credits for this action. Please top up your balance.',
		retryable: false,
	},

	[ErrorCategory.AUTHENTICATION_ERROR]: {
		category: ErrorCategory.AUTHENTICATION_ERROR,
		messageDE: 'Authentifizierung fehlgeschlagen. Bitte melden Sie sich erneut an.',
	...
	[ErrorCategory.NOT_FOUND]: {
		...
		messageDE: 'Die angeforderte Ressource wurde nicht gefunden. Bitte versuchen Sie es erneut.',
...
export const REPLICATE_ERROR_PATTERNS: Array<{
	...
	{
		pattern: /content policy|violates.*policy|inappropriate content|flagged as sensitive/i,
		category: ErrorCategory.INVALID_INPUT,
	},
	// Rate limiting
	{

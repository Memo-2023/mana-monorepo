...
export const IMAGE_MODELS: Record<ImageModelId, ImageModel> = {
	...
	'flux-schnell': {
		id: 'flux-schnell',
		name: 'FLUX Schnell',
		description: 'Schnelle Bildgenerierung in 1-2 Sekunden. Gut für Prototypen und Tests.',
	...
	sdxl: {
		...
		description: 'Bewährte, stabile Bildgenerierung mit konsistenten Ergebnissen.',
	...
	'imagen-4-fast': {
		...
		description: 'Extrem kostengünstige und schnelle Generierung. Ideal für hohe Volumen.',
	...
	'seedream-4': {
		...
		description: '4K Auflösung mit sequenzieller Batch-Generierung. Perfekt für Serien.',
	...
	'ideogram-v3-turbo': {
		...
		description: 'Vielfältige künstlerische Stile mit automatischer Prompt-Optimierung.',
	...
	'nano-banana': {
		...
		creditsPerImage: 4,
		features: ['character-consistency', 'multi-turn-editing', 'image-fusion', 'SynthID'],
		category: 'specialty',
	},
};

...
{:else if character}
	<div class="mx-auto max-w-2xl space-y-8">
		...
		<div class="flex flex-col items-center text-center">
			...
			<div class="relative">
				<div
					class="h-48 w-48 overflow-hidden rounded-full border-4 border-pink-500 shadow-xl shadow-pink-500/20"
				>
					<img
			...
			{#if character.share_code && !isSystem}
				<div class="mt-3 flex items-center gap-2">
					<span
						class="inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-3 py-1 text-sm font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
					>
						<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path
								stroke-linecap="round"
		...
		{#if character.originalDescription}
			<div class="rounded-2xl bg-gray-50 p-6 dark:bg-gray-800/50">
				<h3
					class="mb-3 text-sm font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400"
				>

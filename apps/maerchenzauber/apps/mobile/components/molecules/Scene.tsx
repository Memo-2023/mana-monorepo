		...
		<View style={{ flex: 1 }}>
			...
			>
				{images.map((image, index) => (
					...
					>
						<View
							style={[styles.centerContainer, debugBorderGreen, { paddingTop: 10, marginTop: 0 }]}
						>
									...
									<View style={styles.endContainer}>
										...
										<View style={styles.centeredTextContainer}>
											<Text
												...
												style={[
													styles.centeredText,
													{ fontFamily: 'Grandstander_700Bold', fontSize: 60 },
												]}
											>
												{texts[index]}
											</Text>
									...
									<>
										...
										<View
											style={[
												...
												debugBorderBlue,
												{ width: imageWidth, marginTop: 0, paddingTop: 0 },
											]}
										>
											<ScrollView

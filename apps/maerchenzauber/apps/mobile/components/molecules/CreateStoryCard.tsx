...
const CreateStoryCard: React.FC<CreateStoryCardProps> = ({ onPress, width = DEFAULT_WIDTH, height }) => {
    ...
    >
      ...
      >
        <View style={[styles.content, contentDebug]}>
          ...
          <Text variant="subheader" color="#FFFFFF" style={[styles.title, { fontSize: titleFontSize, lineHeight: titleLineHeight }]}>

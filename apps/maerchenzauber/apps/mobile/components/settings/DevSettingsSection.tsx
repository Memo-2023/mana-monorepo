      ...
      <View style={styles.loadingScreenControls}>
        ...
        <View style={styles.contextSelector}>
          {(['character', 'story', 'image', 'saving', 'loading'] as const).map((context) => (
            <TouchableOpacity
              key={context}
              style={[styles.contextButton, loadingContext === context && styles.activeContextButton]}
              onPress={() => onLoadingContextChange(context)}
            >
              <Text style={[styles.contextButtonText, loadingContext === context && styles.activeContextButtonText]}>
                {context}
              </Text>
            </TouchableOpacity>
          ))}

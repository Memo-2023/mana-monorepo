		...
		articles: [
			{
				...
				content:
					'Märchenzauber ist deine App für magische, personalisierte Kindergeschichten. Erstelle einzigartige Charaktere und lass KI wunderschöne illustrierte Geschichten für dich schreiben.',
			},
			{
				id: 'how-to-start',
	...
	},
	{
		...
		articles: [
			...
			},
			{
				...
				content:
					'Alle Bilder deines Charakters werden konsistent generiert - dein Charakter sieht in jeder Geschichte gleich aus. Das macht es perfekt für wiederkehrende Geschichten mit demselben Helden.',
			},
			{
	...
	},
	{
		...
		articles: [
			...
			},
			{
				...
				content:
					'Jede Geschichte hat 10 wunderschön illustrierte Seiten. Wische nach links/rechts, um durch die Seiten zu blättern. Jede Seite enthält Text und ein passendes Bild.',
			},
			{
				id: 'archive-stories',
		...
		articles: [
			{
				...
				title: 'Archiv',
				content:
					'Im Archiv findest du alle deine archivierten Geschichten. Du kannst sie jederzeit wieder aktivieren oder endgültig löschen.',
			},
		],
	},
	{

        ...
        <ScrollView>
          {storyImages.map((item: StoryImage, index: number) => (
            <View key={index} style={styles.storyPage}>
              ...
              <Text variant="subheader" color="#fff" style={styles.pageNumber}>Seite {item.data.page}</Text>
              <Text variant="body" color="#ccc" style={styles.description}>{item.data.description}</Text>
            </View>
          ))}
        </ScrollView>
      </View>

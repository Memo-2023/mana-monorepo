...
export default function StorySelection() {
	...
	const handleCharacterPress = React.useCallback(
		(character: any) => {
	...
	const handlePublicCharacterPress = React.useCallback(
		(character: any) => {
	...
	return (
		<SafeAreaView style={[styles.safeArea, safeAreaDebug]} edges={['top']}>
			...
			>
				{Platform.OS === 'ios' ? (
					<BlurView tint="dark" intensity={25} style={styles.headerBackground} />
				) : (

...
export default function CharacterPage() {
  ...
  const [selectedSharingPreference, setSelectedSharingPreference] = useState<'private' | 'link_only' | 'public'>('private');
            ...
            <View style={dynamicStyles.container}>
              <View style={styles.characterHeader}>
                ...
                {isEditing ? (
                  ...
                  <>
                    <Text style={[styles.characterName, { fontSize: characterNameSize }]}>{character.name}</Text>
                      ...
                      <View style={styles.sharingStatusContainer}>
                        <View style={styles.sharingBadge}>
                          ...
                          <Text style={styles.sharingBadgeText}>
                            {character.sharing_preference === 'public' ? 'Öffentlich' : 'Nur per Link'}
                          </Text>
                        </View>
                        {character.share_code && (
                          <TouchableOpacity onPress={handleCopyShareCode} style={styles.shareCodeContainer}>
                            <Text style={styles.shareCodeText}>Code: {character.share_code.slice(0, 6)}</Text>
              ...
              <View style={dynamicStyles.section}>
                ...
                {showStoryInfo && (
                  <Text style={[styles.sectionInfo, { fontSize: sectionInfoSize }]}>
                    Schreibe eine neue Geschichte mit {character.name}. Die Geschichte
                    wird automatisch gespeichert und erscheint auf der Startseite.
                  </Text>
                )}
                <TextField
                ...
                <View style={styles.buttonContainer}>
                  <Button
                    title={
                      isSubmitting ? "Wird gespeichert..." : "Geschichte erstellen"
                    }
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity 
              style={[styles.sharingOption, selectedSharingPreference === 'private' && styles.selectedOption]}
            ...
            <TouchableOpacity 
              style={[styles.sharingOption, selectedSharingPreference === 'link_only' && styles.selectedOption]}
            ...
            <TouchableOpacity 
              style={[styles.sharingOption, selectedSharingPreference === 'public' && styles.selectedOption]}
            ...
            <View style={styles.modalButtons}>
              ...
              />
              <Button
                title={character?.is_published && selectedSharingPreference === 'private' ? "Zurückziehen" : "Veröffentlichen"}
                onPress={selectedSharingPreference === 'private' ? handleUnpublishCharacter : handlePublishCharacter}
                variant="primary"
                size="md"
                style={styles.modalButton}
              />

...
import { View, StyleSheet, FlatList, Dimensions, ActivityIndicator, ImageBackground } from 'react-native';
...
export default function CollectionDetailScreen() {
  ...
  const renderCollectionIcon = () => {
    ...
    const iconName = collection?.type === 'contest' ? 'trophy' : 
                    collection?.type === 'seasonal' ? 'calendar' : 
                    collection?.type === 'official' ? 'star' : 'library';
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyStateText}>
        Diese Sammlung enthält noch keine Geschichten
      </Text>
    </View>
  );

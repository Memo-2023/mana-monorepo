...
__export(index_exports, {
  ...
  THEME_DECKS: () => THEME_DECKS,
  formatQuote: () => formatQuote,
  formatQuoteWithNumber: () => formatQuoteWithNumber,
  fuzzySearchQuotes: () => fuzzySearchQuotes,
  ...
  getQuotesByOriginalLanguage: () => getQuotesByOriginalLanguage,
  getQuotesByTag: () => getQuotesByTag,
  getQuotesByThemeDeck: () => getQuotesByThemeDeck,
  getQuotesByYearRange: () => getQuotesByYearRange,
  getRandomQuote: () => getRandomQuote,
  getRandomQuoteByCategory: () => getRandomQuoteByCategory,
  getTotalCount: () => getTotalCount,
  getVerifiedQuotes: () => getVerifiedQuotes,

<script lang="ts">
	...
	import { GridFour, List, FolderPlus, ArrowLeft } from '@mana/shared-icons';
...
<svelte:head>
	<title>{currentFolder?.name || 'Ordner'} - Storage - Mana</title>
</svelte:head>

<RoutePage appId="storage" backHref="/storage/files" title="Ordner">

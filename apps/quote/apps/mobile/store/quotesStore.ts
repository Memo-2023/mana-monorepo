    ...
    (set, get) => ({
      ...
      clearFavorites: () => {
        ...
        set({
          ...
          currentQuote: get().currentQuote ? 
            { ...get().currentQuote!, isFavorite: false } : null
        });
      },
      ...
      getStats: () => {
        ...
        favorites.forEach(quoteId => {
          ...
          if (quote?.authorId) {
            authorCounts.set(
              quote.authorId, 
              (authorCounts.get(quote.authorId) || 0) + 1
            );
          }
        });
      ...
      importFromCloud: async () => {
        ...
        try {
          ...
          const newFavoriteAuthors = [...new Set([...state.favoriteAuthors, ...syncData.favoriteAuthors])];
          ...
          set({
            ...
            viewHistory: [...new Set([...state.viewHistory, ...syncData.viewHistory])].slice(0, 100),

...
const additionalQuotes = {
  'picasso-pablo': [
    ...
    },
    {
      ...
      textEN: "The meaning of things lies not in the things themselves, but in our attitude towards them.",
  ...
  'ali-muhammad': [
    ...
    },
    {
      ...
      textEN: "I hated every minute of training, but I said, 'Don't quit. Suffer now and live the rest of your life as a champion.'",
    ...
    },
    {
      ...
      textEN: "Champions aren't made in gyms. Champions are made from something they have deep inside them - a desire, a dream, a vision.",
  ...
  'yeats-william-butler': [
    ...
    },
    {
      ...
      textEN: "We make out of the quarrel with others, rhetoric, but of the quarrel with ourselves, poetry.",
  ...
  'eliot-george': [
    ...
    },
    {
      ...
      textEN: "Animals are such agreeable friends - they ask no questions, they pass no criticisms.",
    ...
    },
    {
      ...
      textEN: "Blessed is the man who, having nothing to say, abstains from giving us wordy evidence of the fact.",
  ...
  'tracy-brian': [
    ...
    },
    {
      ...
      textEN: "You will never have enough time to do everything, but you will always have enough time to do the most important thing.",
    ...
    },
    {
      ...
      textEN: "Invest the first 10 percent of your day in yourself, and the remaining 90 percent will take care of itself.",
  ...
  'zuckerberg-mark': [
    ...
    },
    {
      ...
      textEN: "Move fast and break things. Unless you are breaking stuff, you are not moving fast enough.",
      categories: ['innovation', 'speed']
    },
    {
      text: "Menschen beeinflussen macht Spaß. Das ist der Grund, warum ich das tue.",
      textEN: "People influence people. Nothing influences people more than a recommendation from a trusted friend.",
    ...
    },
    {
      ...
      textEN: "In a world that's changing really quickly, the only strategy that is guaranteed to fail is not taking risks.",
  ...
  'shedd-john-a': [
    ...
    },
    {
      ...
      textEN: "Courage is not the absence of fear, but deciding that something else is more important.",
  ...
  'lasorda-tommy': [
    {
      ...
      textEN: "The difference between the impossible and the possible lies in a person's determination.",
    ...
    },
    {
      ...
      textEN: "There are three types of players: those who make it happen, those who watch it happen, and those who wonder what happened.",

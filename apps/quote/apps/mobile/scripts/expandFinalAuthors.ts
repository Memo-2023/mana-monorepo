	...
	'kneipp-sebastian': [
		{
			...
			textEN:
				'He who does not invest something for his health every day will one day have to sacrifice a lot of time for illness.',
	...
	'bergman-ingmar': [
		{
			...
			textEN:
				'Aging is like mountain climbing: the higher you get, the more exhausted you become, but the view gets better.',
		...
		},
		{
			...
			textEN:
				'The demons are countless, arrive in the most varied shapes and rob me of all my joy.',

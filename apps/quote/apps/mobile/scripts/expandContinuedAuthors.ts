...
const additionalQuotes = {
  'lincoln-abraham': [
    {
      ...
      textEN: "In the end, it's not the years in your life that count. It's the life in your years.",
    ...
    },
    {
      ...
      textEN: "The probability that we may fail in the struggle ought not to deter us from the support of a cause we believe to be just.",
  ...
  'covey-stephen': [
    ...
    },
    {
      ...
      textEN: "Between stimulus and response there is a space. In that space is our power to choose.",
  ...
  'milne-aa': [
    {
      ...
      textEN: "You are braver than you believe, stronger than you seem, and smarter than you think.",
  ...
  'adler-alfred': [
    ...
    },
    {
      ...
      textEN: "What we do for ourselves dies with us. What we do for others is and remains immortal.",
  ...
  'chinesisches-sprichwort': [
    ...
    },
    {
      ...
      textEN: "Give a man a fish and you feed him for a day. Teach a man to fish and you feed him for a lifetime.",
  ...
  'fischer-thomas': [
    ...
    },
    {
      ...
      textEN: "Human dignity is inviolable - to respect and protect it is the duty of all state authority.",

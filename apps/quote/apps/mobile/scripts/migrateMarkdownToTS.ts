 ...
 */
function mergeAuthors(existing: Map<string, Author>, markdown: Map<string, Author>): Author[] {
		...
		if (merged.has(id)) {
			...
			merged.set(id, {
				...
				biography: {
					...
					famousQuote:
						markdownAuthor.biography?.famousQuote || existingAuthor.biography?.famousQuote,
				},

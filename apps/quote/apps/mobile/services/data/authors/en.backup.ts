...
export const authorsEN: Author[] = [
		...
		biography: {
			...
			sections: {
				earlyLife: {
					...
					content:
						'Born in Cologne as the third of five children in a Catholic civil servant family. Studied law and economics in Freiburg, Munich, and Bonn. Joined the Centre Party in 1906 and began his political career in Cologne.',
				},
				riseToProminence: {
	...
	},
	{
		id: 'jobs-steve',
		name: 'Steve Jobs',
		profession: ['Entrepreneur', 'Business Magnate', 'Inventor'],
		biography: {
			short:
				'American business magnate, industrial designer, investor, and media proprietor. Co-founder of Apple Inc.',
	...
	},
	{
		id: 'churchill-winston',
		name: 'Winston Churchill',
		profession: ['Prime Minister', 'Politician', 'Writer'],
		biography: {

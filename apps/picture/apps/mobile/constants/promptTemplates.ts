...
export const PROMPT_TEMPLATES: PromptTemplate[] = [
	// Portrait Templates
	{
		...
		icon: '👔',
		template:
			'Professional portrait photo of {subject}, {style}, studio lighting, sharp focus, 8k, high quality',
		example:
			'Professional portrait photo of a business woman, cinematic style, studio lighting, sharp focus, 8k, high quality',
	...
	},
	{
		...
		icon: '🎨',
		template:
			'Artistic portrait of {subject}, {style}, dramatic lighting, creative composition, highly detailed',
		example:
			'Artistic portrait of a musician, oil painting style, dramatic lighting, creative composition, highly detailed',
	...
	},
	{
		...
		icon: '🎬',
		template:
			'Cinematic portrait of {subject}, {mood} atmosphere, film grain, depth of field, professional color grading',
		example:
			'Cinematic portrait of a detective, noir atmosphere, film grain, depth of field, professional color grading',
	...
	// Landscape Templates
	{
		...
		icon: '🏞️',
		template:
			'{location} landscape, {time_of_day}, {weather}, natural colors, wide angle, highly detailed, 8k',
		example:
			'Mountain landscape, golden hour, clear sky, natural colors, wide angle, highly detailed, 8k',
	...
	},
	{
		...
		icon: '🏰',
		template:
			'Fantasy {location}, {mood} atmosphere, magical elements, {style}, vibrant colors, epic composition',
		example:
			'Fantasy forest, mystical atmosphere, magical elements, digital art style, vibrant colors, epic composition',
	...
	},
	{
		...
		icon: '🌃',
		template:
			'{city_type} cityscape, {time_of_day}, {weather}, urban photography, architectural details, high contrast',
		example:
			'Modern cityscape, blue hour, light rain, urban photography, architectural details, high contrast',
	...
	// Product Templates
	{
		...
		icon: '📦',
		template:
			'{product} on {background}, minimal style, clean composition, soft lighting, commercial photography, high quality',
		example:
			'Smartphone on white background, minimal style, clean composition, soft lighting, commercial photography, high quality',
	...
	},
	{
		...
		icon: '✨',
		template:
			'{product} in {setting}, lifestyle photography, natural lighting, {mood} atmosphere, realistic, detailed',
		example:
			'Coffee cup in modern kitchen, lifestyle photography, natural lighting, cozy atmosphere, realistic, detailed',
	...
	// Abstract Templates
	{
		...
		icon: '🔷',
		template:
			'Abstract geometric composition, {colors}, {style}, {mood}, minimalist, high resolution',
		example:
			'Abstract geometric composition, vibrant blue and orange, modern style, energetic mood, minimalist, high resolution',
	...
	},
	{
		...
		icon: '🌊',
		template:
			'Abstract fluid art, {colors}, flowing shapes, {style}, smooth gradients, mesmerizing',
		example:
			'Abstract fluid art, purple and gold, flowing shapes, liquid style, smooth gradients, mesmerizing',
	...
	// Architecture Templates
	{
		...
		icon: '🏢',
		template:
			'Modern {building_type}, {style} architecture, {time_of_day}, clean lines, geometric, professional photography',
		example:
			'Modern office building, minimalist architecture, golden hour, clean lines, geometric, professional photography',
	...
	},
	{
		...
		icon: '🛋️',
		template:
			'{room_type} interior, {style} design, {lighting}, spacious, detailed textures, architectural photography',
		example:
			'Living room interior, scandinavian design, natural lighting, spacious, detailed textures, architectural photography',
	...
	// Food Templates
	{
		...
		icon: '🍽️',
		template:
			'Gourmet {dish}, professional food photography, {plating_style}, dramatic lighting, shallow depth of field, appetizing',
		example:
			'Gourmet pasta dish, professional food photography, elegant plating, dramatic lighting, shallow depth of field, appetizing',
	...
	},
	{
		...
		icon: '🥖',
		template:
			'Rustic {dish}, natural food photography, {setting}, warm lighting, authentic, homemade feel',
		example:
			'Rustic bread and cheese, natural food photography, wooden table, warm lighting, authentic, homemade feel',

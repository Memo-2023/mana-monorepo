...
export default function GalleryScreen() {
  ...
  // Store hooks
  const { galleryViewMode, setGalleryViewMode, lastViewedImageId, setLastViewedImageId } = useViewStore();
  ...
  useEffect(() => {
    const checkForCompletions = () => {
      ...
      const completed = allGenerating.find(img => img.status === 'completed' && img.generationTime);
          ...
          ListHeaderComponent={
            <>
              <View style={{
                ...
                <Text variant="title" weight="bold">Galerie</Text>

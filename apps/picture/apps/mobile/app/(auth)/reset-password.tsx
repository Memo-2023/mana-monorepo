    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <Container>
        ...
        <View className="flex-1 justify-center">
          <View className="mb-8">
            <Text variant="h1" color="primary" align="center" className="mb-2">Passwort zurücksetzen</Text>
          ...
          <View className="space-y-4">
            ...
            <View className="flex-row justify-center mt-6">
              <Link href="/(auth)/login" asChild>
                <Text variant="body" style={{ color: theme.colors.primary.default }}>Zurück zur Anmeldung</Text>
              </Link>
            </View>
          </View>
        </View>

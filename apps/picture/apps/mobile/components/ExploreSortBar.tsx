...
import { View, ScrollView, Pressable, PlatformColor } from 'react-native';
								...
								>
									...
									<Pressable
										...
										style={{
											...
											backgroundColor:
												sortMode === 'recent' ? theme.colors.primary.default : 'transparent',
											marginRight: 8,
										}}
									>
										<Ionicons
										...
										style={{
											...
											borderColor:
												sortMode === 'popular'
													...
													: PlatformColor('separatorColor'),
											backgroundColor:
												sortMode === 'popular' ? theme.colors.primary.default : 'transparent',
											marginRight: 8,
										}}
									>
										<Ionicons
										...
										style={{
											...
											borderColor:
												sortMode === 'trending'
													...
													: PlatformColor('separatorColor'),
											backgroundColor:
												sortMode === 'trending' ? theme.colors.primary.default : 'transparent',
											marginRight: 8,
										}}
									>
										<Text
											style={{
												color: sortMode === 'trending' ? 'white' : PlatformColor('labelColor'),
												fontSize: 14,
												fontWeight: '600',
											}}
										>

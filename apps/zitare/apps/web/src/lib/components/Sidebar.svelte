...
<aside class="desktop-sidebar" class:collapsed={$isSidebarCollapsed}>
	...
	<div class="sidebar-header">
		<a href="/" class="sidebar-logo"> 📖 Zitare </a>
		<button
	...
	<div class="sidebar-footer">
		<div class="user-section">
			...
			{#if showUserMenu}
				<div class="user-menu">
					<a href="/settings" onclick={() => (showUserMenu = false)} class="user-menu-item">
...
<header class="mobile-header">
	<div class="mobile-header-content">
		<!-- Logo -->
		<a href="/" class="mobile-logo"> 📖 Zitare </a>

		<!-- User Avatar -->
		<button onclick={() => (showUserMenu = !showUserMenu)} class="mobile-avatar"> U </button>
	</div>
...
<nav class="mobile-bottom-nav">
	<div class="bottom-nav-grid">
		{#each navItems as item}
			{@const active = isActive(item.path)}
			<a href={item.path} class="bottom-nav-item" class:active>
				<svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d={item.icon} />
				</svg>
				<span>{item.label}</span>

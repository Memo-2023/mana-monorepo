	...
	'kaestner-erich': [
		{
			...
			textEN:
				"All mischief that happens is not only the fault of those who do it, but also those who don't prevent it.",
		...
		},
		{
			...
			textEN:
				'Mistakes have their value; but only here and there. Not everyone who sails to India discovers America.',

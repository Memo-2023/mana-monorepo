...
const additionalQuotes = {
	...
	'morgenstern-christian': [
		...
		},
		{
			...
			textEN:
				'One often sees something a hundred times, a thousand times, before really seeing it for the first time.',
	...
	'lao-tzu': [
		{
			...
			textEN:
				'Water is the softest thing in the world, yet nothing surpasses it in conquering the hard.',
	...
	'rousseau-jean-jacques': [
		...
		},
		{
			...
			textEN:
				'The strongest is never strong enough to be always master, unless he transforms his strength into right.',

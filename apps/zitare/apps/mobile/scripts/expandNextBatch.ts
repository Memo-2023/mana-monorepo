...
const additionalQuotes = {
	...
	moliere: [
		{
			...
			textEN:
				'It is not only the great things that put us on the right path. The small, frequently repeated kindnesses are what conquer the heart.',
		...
		},
		{
			...
			textEN:
				'People are alike in their words, but it is in their deeds that we recognize the differences.',
	...
	'shaw-george-bernard': [
		...
		},
		{
			...
			textEN:
				"People who say there's no such thing as bad publicity have never been publicly ridiculed.",

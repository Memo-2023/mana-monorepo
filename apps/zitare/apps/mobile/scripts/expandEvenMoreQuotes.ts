...
const additionalQuotes = {
	...
	'gibran-khalil': [
		...
		},
		{
			...
			textEN:
				'Trees teach us silence when they are quiet, and they teach us to speak when they rustle.',
			categories: ['nature', 'wisdom'],
		},
		{
			text: 'Vertrauen ist eine Oase im Herzen, die von der Karawane des Denkens nie erreicht wird.',
			textEN:
				'Trust is an oasis in the heart which will never be reached by the caravan of thinking.',
	...
	'adenauer-konrad': [
		...
		},
		{
			...
			textEN:
				"You have to take things as they come. But you should make sure they come as you'd like to take them.",
	...
	'franz-von-assisi': [
		...
		},
		{
			...
			textEN:
				'All creatures of the earth feel as we do, all creatures strive for happiness as we do.',
	...
	epiktet: [
		{
			...
			textEN:
				"It's not things themselves that disturb us, but our interpretations of their significance.",
	...
	hippokrates: [
		...
		},
		{
			...
			textEN:
				'Illnesses do not come upon us out of the blue. They are developed from daily sins against nature.',
	...
	'schiller-friedrich': [
		...
		},
		{
			...
			textEN:
				'What is the majority? Majority is nonsense; understanding has always been with only a few.',

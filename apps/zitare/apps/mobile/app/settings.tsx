	...
	const handleResetAllData = async () => {
		Alert.alert(
			...
			t('settings.resetAllDataConfirm', {
				defaultValue:
					'Möchtest du wirklich ALLE Daten löschen? Dies umfasst Favoriten, Playlists, Einstellungen und alle anderen App-Daten. Diese Aktion kann nicht rückgängig gemacht werden!',
			}),
			[
				{
						...
						try {
							...
							Alert.alert(
								...
								t('settings.resetError', {
									defaultValue: 'Daten konnten nicht zurückgesetzt werden.',
								})
							);
						}
					},
				...
				>
					...
					<View className="px-6">
						...
						<View className="mb-8">
							...
							>
								<View
									className={`${isDarkMode ? 'bg-white/10' : 'bg-black/10'} rounded-2xl p-4 ${isPremium ? 'border-2' : ''}`}
									style={isPremium ? { borderColor: '#8B5CF6' } : {}}
								>
									<View className="flex-row items-center justify-between mb-3">
										<View className="flex-row items-center">
											<View
												className={`w-10 h-10 rounded-full ${isPremium ? 'bg-purple-500/20' : isDarkMode ? 'bg-white/10' : 'bg-black/10'} items-center justify-center mr-3`}
											>
												<Ionicons
										...
										{!isPremium && (
											<View
												className={`${isDarkMode ? 'bg-white/20' : 'bg-black/20'} px-3 py-1 rounded-full`}
											>
										...
										<View>
											...
											<View className="space-y-2">
												<View className="flex-row items-center justify-between mb-2">
													...
													<Text variant="caption" weight="semibold" color="primary">
														{getRemainingFavorites() === -1
															? '∞'
															: `${getRemainingFavorites()} / 3`}
													</Text>
												</View>
												<View className="flex-row items-center justify-between mb-2">
													<View className="flex-row items-center">
											...
											<View
												className={`mt-3 pt-3 border-t ${isDarkMode ? 'border-white/10' : 'border-black/10'}`}
											>
												<Text
													variant="caption"
													weight="semibold"
						...
						<View className="mb-8">
							...
							{/* Dark Mode Toggle */}
							<View
								className={`${isDarkMode ? 'bg-white/10' : 'bg-black/10'} rounded-2xl p-4 mb-4`}
							>
							...
							{/* Theme Selection */}
							<View
								className={`${isDarkMode ? 'bg-white/10' : 'bg-black/10'} rounded-2xl overflow-hidden`}
							>
							...
							<View className={`${isDarkMode ? 'bg-white/10' : 'bg-black/10'} rounded-2xl p-4`}>
								<View className="flex-row justify-between items-center">
									...
									<View className="flex-row">
										...
										>
											<Text
												className={`${isDarkMode ? 'text-white' : 'text-black'} text-sm font-medium`}
											>
												DE
											</Text>
										</Pressable>
							...
							<View className={`${isDarkMode ? 'bg-white/10' : 'bg-black/10'} rounded-2xl`}>
									...
									<View className="flex-1">
										...
										<Text variant="caption" color="secondary" className="mt-1">
											{t('settings.resetAllDataDesc', {
												defaultValue: 'Löscht Favoriten, Playlists und Einstellungen',
											})}
										</Text>
									</View>
								...
								>
									<View className="flex-1">
										...
										<Text variant="caption" color="secondary">
											Zeigt die Einführung erneut an
										</Text>
									</View>
									<Ionicons

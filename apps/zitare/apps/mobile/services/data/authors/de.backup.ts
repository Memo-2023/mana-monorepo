...
export const authorsDE: Author[] = [
	...
	},
	{
		...
		biography: {
			...
			long: "Antoine de Saint-Exupéry war ein französischer Schriftsteller und Flieger. Sein bekanntestes Werk 'Der kleine Prinz' gehört zu den meistübersetzten Büchern der Welt.",
			sections: {
				childhood: {
					title: 'Kindheit und Jugend (1900-1921)',
					content:
						'Geboren in Lyon in eine aristokratische Familie. Verlor früh seinen Vater und wurde von seiner Mutter Marie erzogen. Zeigte früh Interesse an Mechanik und Technik, träumte vom Fliegen.',
				},
				aviator: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Konfuzius war der einflussreichste Denker Chinas und prägte über 2500 Jahre die chinesische Kultur und Gesellschaft. Seine Lehren von Moral, Ethik und sozialer Harmonie beeinflussten ganz Ostasien.',
			sections: {
				earlyLife: {
					title: 'Bescheidene Anfänge (551-527 v.Chr.)',
					content:
						'Geboren als Kong Qiu in Lu (heute Shandong) in einfache Verhältnisse. Verlor früh den Vater, wurde von der Mutter erzogen. Arbeitete als junger Mann in verschiedenen niederen Ämtern, bildete sich autodidaktisch.',
				},
				teacher: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				youth: {
					title: 'Augsburger Jugend (1898-1918)',
					content:
						'Aufgewachsen in bürgerlichen Verhältnissen in Augsburg. Erlebte den Ersten Weltkrieg als Sanitäter, wurde zum überzeugten Pazifisten. Begann früh zu schreiben, erste Gedichte entstanden bereits in der Schulzeit.',
				},
				weimar: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Friedrich Nietzsche war einer der einflussreichsten Philosophen der Neuzeit. Seine radikale Kritik der Moral, Religion und Metaphysik prägte das moderne Denken nachhaltig.',
			sections: {
				youth: {
					title: 'Jugend und Studium (1844-1869)',
					content:
						'Geboren als Pfarrerssohn in Röcken, verlor früh den Vater. Studierte klassische Philologie in Bonn und Leipzig. Mit nur 24 Jahren wurde er Professor in Basel - jüngster Professor seiner Zeit.',
				},
				basel: {
	...
	},
	{
		...
		biography: {
			...
			long: "Ludwig Wittgenstein revolutionierte die Philosophie zweimal: erst mit dem 'Tractus logico-philosophicus', dann mit den 'Philosophischen Untersuchungen'. Seine Sprachphilosophie prägte das 20. Jahrhundert.",
			sections: {
				aristocrat: {
					title: 'Aristokratische Herkunft (1889-1911)',
					content:
						'Geboren in eine der reichsten Familien Österreichs. Sein Vater Karl war Stahlindustrieller, die Familie förderte Künstler wie Brahms und Klimt. Studierte zunächst Ingenieurswissenschaften in Berlin und Manchester.',
				},
				cambridge: {
	...
	},
	{
		...
		biography: {
			...
			long: "René Descartes revolutionierte mit seinem methodischen Zweifel die Philosophie und Wissenschaft. Sein berühmter Ausspruch 'Cogito ergo sum' begründete die moderne Erkenntnistheorie.",
			sections: {
				jesuit: {
					title: 'Jesuitische Ausbildung (1596-1616)',
					content:
						'Geboren in La Haye, erhielt eine umfassende jesuitische Bildung am Collège Royal. Studierte Rhetorik, Philosophie und Mathematik. Die strenge scholastische Ausbildung weckte paradoxerweise seinen Zweifel an überlieferten Wahrheiten.',
				},
				soldier: {
	...
	},
	{
		...
		biography: {
			...
			long: "Johann Wolfgang von Goethe gilt als einer der bedeutendsten Repräsentanten deutschsprachiger Dichtung. Werke wie 'Faust' und 'Die Leiden des jungen Werthers' prägten die Weltliteratur.",
			sections: {
				frankfurt: {
					title: 'Frankfurter Jugend (1749-1765)',
					content:
						'Geboren als Sohn eines wohlhabenden Patriziers in Frankfurt. Erhielt umfassende Privatausbildung in Sprachen, Künsten und Wissenschaften. Früh literarisch interessiert, schrieb bereits als Jugendlicher Gedichte.',
				},
				leipzig: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				youth: {
					title: 'Jugend und Kaufmannslehre (1788-1809)',
					content:
						'Geboren in Danzig als Sohn eines wohlhabenden Kaufmanns. Sollte das Handelsgeschäft übernehmen, brach aber nach dem Suizid seines Vaters die Kaufmannslaufbahn ab und widmete sich der Philosophie.',
				},
				studies: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				tribal: {
					title: 'Traditionelle Kindheit (1918-1943)',
					content:
						'Geboren in Mvezo, wuchs im königlichen Haus der Thembu auf. Erhielt eine westliche Bildung, studierte Jura in Johannesburg. Erste Begegnungen mit Rassismus prägten sein politisches Bewusstsein.',
				},
				lawyer: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				algeria: {
					title: 'Algerische Kindheit (1913-1930)',
					content:
						'Geboren in Mondovi, Algerien, in ärmste Verhältnisse. Vater fiel im Ersten Weltkrieg, Mutter war Analphabetin. Dank eines Lehrers konnte er studieren. Die mediterrane Sonne und das Meer prägten seine Philosophie des Lebens.',
				},
				paris: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				childhood: {
					title: 'Traditionelle Kindheit (1869-1888)',
					content:
						'Geboren in Porbandar, Gujarat, in eine streng religiöse Hindu-Familie. Verheiratet mit 13 Jahren mit Kasturba. Schüchterner Schüler, aber stark von jainistischen Prinzipien der Gewaltlosigkeit geprägt.',
				},
				london: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				earlyLife: {
					title: 'Jugend und Ausbildung (121-161)',
					content:
						'Geboren als Marcus Annius Verus in eine wohlhabende römische Familie. Kaiser Hadrian entdeckte seine Begabung und sorgte für eine umfassende Ausbildung in Rhetorik und Philosophie. Adoptiert von Kaiser Antoninus Pius und auf die Nachfolge vorbereitet.',
				},
				reign: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				adoption: {
					title: 'Adoption und frühe Jahre (1955-1972)',
					content:
						'Adoptiert von Paul und Clara Jobs in Mountain View, Kalifornien. Wuchs im Herzen des Silicon Valley auf, entwickelte früh Interesse an Elektronik. Sein Adoptivvater lehrte ihm Handwerk und Perfektion.',
				},
				dropout: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				childhood: {
					title: 'Schwierige Kindheit (1847-1863)',
					content:
						"Geboren in Ohio, galt als 'schwieriges' Kind mit Hörproblemen. Mutter Nancy unterrichtete ihn zu Hause, da Lehrer ihn für 'zu dumm' hielten. Früh fasziniert von Chemie und Technik, baute im Keller ein Labor auf.",
				},
				telegrapher: {
	...
	},
	{
		...
		biography: {
			...
			sections: {
				earlyLife: {
					title: 'Kindheit in Stageira (384-367 v.Chr.)',
					content:
						'Geboren in Stageira als Sohn des Hofarzes Nikomachus. Früh verwaist, erhielt er eine umfassende Ausbildung und entwickelte sein Interesse für Naturbeobachtung und systematisches Denken.',
				},
				academy: {
	...
	},
	{
		...
		biography: {
			...
			long: "Napoleon Hill war ein amerikanischer Schriftsteller, der als einer der ersten und erfolgreichsten Autoren von Selbsthilfe-Literatur gilt. Sein Buch 'Think and Grow Rich' ist ein Klassiker der Motivationsliteratur und hat Millionen von Menschen inspiriert.",
			sections: {
				earlyLife: {
					title: 'Armut und frühe Jahre (1883-1900)',
					content:
						'Geboren in einer armen Familie in den Bergen von Virginia. Schon als Kind musste er hart arbeiten und erfuhr früh die Bedeutung von Entschlossenheit und Ausdauer. Seine Stiefmutter ermutigte ihn, seine rebellische Natur in produktive Bahnen zu lenken.',
				},
				journalism: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Epiktet war ein antiker Philosoph und einer der einflussreichsten Vertreter der späten Stoa. Seine Lehren betonen die Unterscheidung zwischen dem, was in unserer Macht steht und dem, was nicht. Aus der Sklaverei zur geistigen Freiheit - sein Leben ist ein Beispiel für die Macht der stoischen Philosophie.',
			sections: {
				slavery: {
					title: 'Sklaverei in Rom (ca. 50-85 n.Chr.)',
					content:
						"Geboren als Sklave in Hierapolis (heute Türkei), kam früh nach Rom. Sein Name bedeutet 'der Hinzuerworbene'. Trotz körperlicher Behinderung - sein Bein war gelähmt - entwickelte er einen unerschütterlichen Geist und erkannte früh die Macht der inneren Freiheit.",
				},
				education: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Mark Zuckerberg gründete Facebook während seines Studiums in Harvard. Er baute das soziale Netzwerk zu einem der wertvollsten Unternehmen der Welt aus und revolutionierte damit die Art, wie Menschen kommunizieren und Informationen teilen.',
			sections: {
				childhood: {
					title: 'Frühe Programmiertalente (1984-2002)',
					content:
						"Aufgewachsen in Dobbs Ferry, New York, zeigte er schon früh außergewöhnliche Programmiertalente. Mit 12 Jahren entwickelte er 'ZuckNet', ein Nachrichtensystem für die Zahnarztpraxis seines Vaters. Besuchte die Phillips Exeter Academy, wo er weitere Programme entwickelte.",
				},
				harvard: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Franz von Assisi war der Begründer des Ordens der Minderbrüder und gilt als Schutzpatron Italiens und des Umweltschutzes. Vom reichen Kaufmannssohn zum demütigen Heiligen - seine radikale Hinwendung zu Armut und Nächstenliebe inspiriert Menschen bis heute.',
			sections: {
				youth: {
					title: 'Reiche Jugend in Assisi (1181-1202)',
					content:
						"Geboren als Giovanni di Pietro di Bernardone in eine wohlhabende Tuchhändlerfamilie. Führte das ausschweifende Leben eines reichen jungen Mannes, liebte Feste und träumte von ritterlichem Ruhm. Sein Vater nannte ihn 'Francesco' (der Franzose) wegen seiner Vorliebe für französische Kultur.",
				},
				conversion: {
	...
	},
	{
		...
		biography: {
			...
			long: 'John Ruskin war der einflussreichste Kunstkritiker des 19. Jahrhunderts und ein bedeutender Sozialreformer. Seine Ideen über Kunst, Architektur und Gesellschaft prägten das viktorianische England und wirkten weit über seine Zeit hinaus.',
			sections: {
				education: {
					title: 'Privilegierte Kindheit und Ausbildung (1819-1843)',
					content:
						'Geboren in London als Sohn eines wohlhabenden Weinhändlers. Erhielt eine umfassende Privatausbildung und studierte in Oxford. Frühe Reisen durch Europa, besonders Italien, prägten seine Liebe zur Kunst und Architektur. Entwickelte schon als Student seine einzigartigen Beobachtungsgaben.',
				},
				artCritic: {
	...
	},
	{
		...
		biography: {
			...
			long: "Hermann Hesse war einer der meistgelesenen deutschsprachigen Schriftsteller des 20. Jahrhunderts. Seine Werke wie 'Siddhartha' und 'Der Steppenwolf' prägten Generationen und machten ihn zu einem der bedeutendsten Vertreter der deutschen Literatur.",
			sections: {
				youth: {
					title: 'Strenge Kindheit und frühe Rebellion (1877-1895)',
					content:
						'Geboren in Calw als Sohn eines Missionars und Verlegers. Wuchs in streng pietistischer Atmosphäre auf. Schon früh rebellierte er gegen die Enge seines Elternhauses. Nach einem Selbstmordversuch mit 15 Jahren wurde er in eine Anstalt gebracht - ein traumatisches Erlebnis, das sein Werk prägte.',
				},
				apprentice: {
	...
	},
	{
		...
		biography: {
			...
			long: "Khalil Gibran war ein libanesisch-amerikanischer Maler, Philosoph und Dichter. Sein Werk 'Der Prophet' gehört zu den meistverkauften Büchern aller Zeiten und verbindet östliche Weisheit mit westlicher Literatur. Er wurde zu einer Brücke zwischen den Kulturen.",
			sections: {
				lebanon: {
					title: 'Kindheit im Libanon (1883-1895)',
					content:
						'Geboren in Bsharri, einem Bergdorf im Libanon, als Sohn einer maronitisch-christlichen Familie. Wuchs in ärmlichen Verhältnissen auf. Sein Vater war Steuereintreiber, seine Mutter Kamila eine starke Frau, die die Familie zusammenhielt. Die mystische Landschaft und religiöse Tradition des Libanon prägten ihn nachhaltig.',
				},
				immigration: {
	...
	},
	{
		...
		biography: {
			...
			long: "Eleanor Roosevelt war eine der einflussreichsten Frauen des 20. Jahrhunderts. Sie kämpfte für Menschenrechte und war maßgeblich an der Allgemeinen Erklärung der Menschenrechte beteiligt. Von der schüchternen Waise zur 'First Lady of the World' - ihr Leben war ein Beispiel für Mut und Engagement.",
			sections: {
				childhood: {
					title: 'Schwere Kindheit und frühe Prägung (1884-1902)',
					content:
						'Geboren in New York in eine privilegierte Familie, verlor sie früh beide Eltern und wuchs bei ihrer strengen Großmutter auf. War ein schüchternes, unsicheres Kind mit wenig Selbstvertrauen. Die Erfahrung des Verlassenseins prägte ihre spätere Empathie für Benachteiligte.',
				},
				marriage: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Carl Gustav Jung war ein Schweizer Psychiater und der Begründer der analytischen Psychologie. Er entwickelte Konzepte wie Archetypen, das kollektive Unbewusste und Persönlichkeitstypen. Seine Ideen revolutionierten das Verständnis der menschlichen Psyche und beeinflussten Psychologie, Literatur und Kultur nachhaltig.',
			sections: {
				youth: {
					title: 'Mystische Kindheit am Rhein (1875-1895)',
					content:
						'Geboren in Kesswil am Bodensee als Sohn eines Pfarrers. Schon als Kind hatte er visionäre Erlebnisse und Träume, die ihn tief prägten. Wuchs in einer Familie auf, die von Geistern und übersinnlichen Phänomenen sprach. Diese frühen mystischen Erfahrungen wurden zur Grundlage seines späteren Werks.',
				},
				medical: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Bruce Lee revolutionierte die Kampfkunst und brachte sie in den Westen. Er gründete das Jeet Kune Do und wurde zur Ikone der Martial Arts. In nur 32 Lebensjahren veränderte er die Welt der Kampfkünste für immer und wurde zum Symbol für Stärke, Philosophie und kulturelle Brücken.',
			sections: {
				hongkong: {
					title: 'Kindheit in Hong Kong (1940-1959)',
					content:
						'Geboren in San Francisco, wuchs in Hong Kong auf. Schon als Kind war er in Straßenkämpfe verwickelt und begann mit 13 Jahren Wing Chun bei Meister Yip Man zu lernen. War auch als Kinderdarsteller in Hong Kong-Filmen aktiv und zeigte früh sowohl kämpferische als auch schauspielerische Talente.',
				},
				america: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Katharina von Siena war eine italienische Mystikerin und eine der ersten Frauen, die zur Kirchenlehrerin ernannt wurden. In nur 33 Lebensjahren beeinflusste sie Päpste, beendete politische Konflikte und wurde zu einer der bedeutendsten Gestalten des Mittelalters.',
			sections: {
				childhood: {
					title: 'Mystische Kindheit (1347-1363)',
					content:
						'Geboren als 23. Kind einer Färberfamilie in Siena. Schon mit 6 Jahren hatte sie ihre erste Vision von Christus. Mit 7 Jahren legte sie ein Keuschheitsgelübde ab. Weigerte sich zu heiraten und trat mit 16 Jahren den Dominikaner-Terziaren bei, einer Laiengemeinschaft.',
				},
				mystical: {
	...
	},
	{
		...
		biography: {
			...
			long: 'William James gilt als Vater der amerikanischen Psychologie und war einer der führenden Vertreter des philosophischen Pragmatismus. Er revolutionierte das Verständnis von Bewusstsein und Erfahrung und legte die Grundsteine für die moderne Psychologie.',
			sections: {
				youth: {
					title: 'Intellektuelle Familie und Krisen (1842-1869)',
					content:
						'Geboren in New York in eine wohlhabende, intellektuelle Familie. Sein Bruder Henry wurde ein berühmter Schriftsteller. Litt unter Depressionen und einer existentiellen Krise, die ihn fast zum Selbstmord getrieben hätte. Diese persönlichen Kämpfe prägten sein späteres Verständnis für die menschliche Psyche und den Willen.',
				},
				medicine: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Anaïs Nin war eine französisch-amerikanische Schriftstellerin, die vor allem durch ihre literarischen Tagebücher bekannt wurde. Sie war eine Pionierin der weiblichen Selbstwahrnehmung in der Literatur und eine der ersten Frauen, die offen über Sexualität und Psychoanalyse schrieb.',
			sections: {
				childhood: {
					title: 'Frühe Prägung und Tagebuch-Anfang (1903-1920)',
					content:
						'Geboren in Neuilly-sur-Seine bei Paris als Tochter eines kubanischen Komponisten und einer dänisch-französischen Sängerin. Als der Vater die Familie 1914 verließ, zog die Mutter mit den Kindern nach New York. Mit 11 Jahren begann Anaïs ihr Tagebuch zu schreiben - zunächst als Brief an den abwesenden Vater.',
				},
				marriage: {
	...
	},
	{
		...
		biography: {
			...
			long: "Maya Angelou war eine der einflussreichsten Stimmen der amerikanischen Literatur und Bürgerrechtsbewegung. Ihre Autobiografie 'I Know Why the Caged Bird Sings' machte sie weltberühmt.",
			sections: {
				childhood: {
					title: 'Schwere Kindheit (1928-1944)',
					content:
						'Geboren als Marguerite Annie Johnson in Missouri. Erlebte Rassismus, Armut und sexuellen Missbrauch. Nach einem traumatischen Erlebnis verstummte sie fast fünf Jahre lang. Bücher und Literatur halfen ihr, ihre Stimme wiederzufinden.',
				},
				youngAdult: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Alan Alexander Milne schuf mit Winnie-the-Pooh eine der beliebtesten Kinderbuchfiguren der Welt. Seine Geschichten aus dem Hundert-Morgen-Wald verzaubern seit Generationen Kinder und Erwachsene.',
			sections: {
				earlyLife: {
					title: 'Kindheit und Ausbildung (1882-1903)',
					content:
						"Geboren in London als Sohn eines Schulleiters. Studierte Mathematik am Trinity College Cambridge, wo er auch als Herausgeber der Studentenzeitung 'Granta' tätig war. Diese Zeit prägte seine schriftstellerischen Ambitionen.",
				},
				journalism: {
	...
	},
	{
		...
		biography: {
			...
			long: "Albert Schweitzer war ein Universalgelehrter, der als Arzt, Theologe, Philosoph und Musiker wirkte. Seine Ethik der 'Ehrfurcht vor dem Leben' beeinflusste das humanitäre Denken des 20. Jahrhunderts.",
			sections: {
				education: {
					title: 'Studium und frühe Laufbahn (1875-1905)',
					content:
						'Geboren im Elsass, studierte Theologie, Philosophie und Musik. Promovierte in Theologie und Philosophie, wurde Privatdozent und galt als herausragender Bach-Interpret. Entschied sich mit 30 Jahren für ein völlig neues Leben.',
				},
				calling: {
	...
	},
	{
		id: 'drucker-peter',
		name: 'Peter Drucker',
		profession: ['Management Consultant', 'Author', 'Educator'],
		biography: {
			short:
				'Österreichisch-amerikanischer Managementberater und Autor, gilt als Begründer der modernen Managementlehre.',
		},
		lifespan: {
			birth: '1909-11-19',
			death: '2005-11-11',
	...
	},
	{
		...
		biography: {
			short:
				"Deutsch-schweizerischer Schriftsteller und Literaturnobelpreisträger, bekannt für 'Der Steppenwolf' und 'Siddhartha'.",
		},
		lifespan: {
			birth: '1877-07-02',
			death: '1962-08-09',
	...
	},
	{
		...
		biography: {
			short:
				'Amerikanischer Unternehmer und Gründer der Ford Motor Company, Pionier der Massenproduktion.',
		},
		lifespan: {
			birth: '1863-07-30',
			death: '1947-04-07',
	...
	},
	{
		...
		biography: {
			...
			long: 'Alan Kay ist einer der einflussreichsten Computerwissenschaftler des 20. Jahrhunderts. Als Mitentwickler der objektorientierten Programmierung und Schöpfer der Programmiersprache Smalltalk prägte er die moderne Softwareentwicklung grundlegend. Bei Xerox PARC war er maßgeblich an der Entwicklung der grafischen Benutzeroberfläche, der Maus und des Personal Computers beteiligt.',
			sections: {
				earlyLife: {
					title: 'Frühe Jahre und Ausbildung',
					content:
						'Geboren 1940 in Springfield, Massachusetts, zeigte Kay früh Interesse an Wissenschaft und Musik. Er studierte Mathematik und Molekularbiologie an der University of Colorado und promovierte 1969 in Informatik an der University of Utah, wo er von Ivan Sutherland, dem Pionier der Computergrafik, betreut wurde.',
				},
				xeroxParc: {
	...
	},
	{
		...
		biography: {
			...
			long: 'Augustinus von Hippo war einer der wichtigsten christlichen Denker und Kirchenväter. Seine Werke beeinflussten das christliche Denken über Jahrhunderte und prägten die westliche Philosophie nachhaltig.',
			sections: {
				youth: {
					title: 'Jugend und Irrwege (354-386)',
					content:
						'Geboren in Tagaste (heute Algerien) als Sohn einer christlichen Mutter und eines heidnischen Vaters. Lebte in seiner Jugend ausschweifend, hatte einen unehelichen Sohn und wandte sich der Sekte der Manichäer zu. Studierte Rhetorik und lehrte in Rom und Mailand.',
				},
				conversion: {
	...
	},
	{
		id: 'lasorda-tommy',
		name: 'Tommy Lasorda',
		profession: ['Baseball Manager', 'Player'],
		biography: {
	...
	},
	{
		...
		biography: {
			short:
				'Deutschsprachiger Schriftsteller und einer der bedeutendsten Vertreter der Weltliteratur des 20. Jahrhunderts.',
			long: 'Franz Kafka war ein deutschsprachiger Schriftsteller. Sein Hauptwerk bilden neben drei Romanfragmenten zahlreiche Erzählungen.',
		},
		lifespan: {
			birth: '1883-07-03',
			death: '1924-06-03',
	...
	},
	{
		...
		biography: {
			...
			long: 'Heraklit von Ephesos war ein vorsokratischer Philosoph. Er gehört zu den bedeutendsten Philosophen der griechischen Antike.',
		},
		lifespan: {
			birth: '-540',
			death: '-480',
	...
	},
	{
		...
		biography: {
			short: 'Deutscher Dramatiker, Lyriker und Begründer des epischen Theaters.',
			long: 'Bertolt Brecht gilt als einflussreichster deutscher Dramatiker und Lyriker des 20. Jahrhunderts.',
		},
		lifespan: {
			birth: '1898-02-10',
			death: '1956-08-14',
	...
	},
	{
		...
		biography: {
			short: 'Deutscher Schriftsteller, Publizist, Drehbuchautor und Kabarettdichter.',
			long: 'Erich Kästner war ein deutscher Schriftsteller, Publizist, Drehbuchautor und Kabarettdichter. Bekannt vor allem für seine Kinderbücher.',
		},
		lifespan: {
			birth: '1899-02-23',
			death: '1974-07-29',
	...
	},
	{
		...
		profession: ['Philosopher', 'Writer', 'Composer'],
		biography: {
			short: 'Genfer Schriftsteller, Philosoph, Pädagoge und Naturforscher der Aufklärung.',
			long: 'Jean-Jacques Rousseau war ein französischsprachiger Schriftsteller, Philosoph und Pädagoge der Aufklärung.',
		},
		lifespan: {
			birth: '1712-06-28',
			death: '1778-07-02',
	...
	},
	{
		...
		profession: ['Philosopher', 'Statesman', 'Scientist'],
		biography: {
			short: 'Englischer Philosoph, Staatsmann und als Wissenschaftler Wegbereiter des Empirismus.',
			long: 'Francis Bacon war ein englischer Philosoph, Jurist, Staatsmann und gilt als Wegbereiter des Empirismus.',
		},
		lifespan: {
			birth: '1561-01-22',
			death: '1626-04-09',
	...
	},
	{
		...
		biography: {
			short:
				'Amerikanischer Erfinder und Automobilpionier, Gründer des Automobilherstellers Ford Motor Company.',
			long: 'Henry Ford war der Gründer des Automobilherstellers Ford Motor Company. Er perfektionierte die Fließbandtechnik im Automobilbau.',
		},
		lifespan: {
			birth: '1863-07-30',
			death: '1947-04-07',
	...
	},
	{
		...
		biography: {
			...
			long: 'Demokrit war ein griechischer Philosoph, der zu den Vorsokratikern gezählt wird.',
		},
		lifespan: {
			birth: '-460',
			death: '-370',

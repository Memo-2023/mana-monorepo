...
<main class="flex min-h-screen items-center justify-center p-4">
  <div class="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl dark:bg-gray-800">
    ...
    {#if needsVerification}
      <div class="rounded-lg bg-green-100 p-4 text-center text-green-700 dark:bg-green-900/30 dark:text-green-400">
        ...
        <a href="/login" class="mt-4 inline-block font-semibold text-green-600 hover:text-green-700 dark:text-green-400">
          Zur Anmeldung
        </a>
      </div>
    {:else}
      ...
      <div class="mt-6 text-center">
        <p class="text-gray-600 dark:text-gray-400">
          Bereits ein Konto?
          <a href="/login" class="font-semibold text-green-600 hover:text-green-700 dark:text-green-400">
            Anmelden
          </a>
        </p>
      </div>

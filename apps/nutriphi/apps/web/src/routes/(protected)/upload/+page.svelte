    ...
    <div class="mx-auto max-w-2xl">
      ...
      {#if !selectedFile}
        ...
        >
          ...
          <label class="inline-block cursor-pointer rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3 font-semibold text-white shadow-lg transition-all hover:from-green-600 hover:to-emerald-700">
            Foto auswählen
            <input
              type="file"
              accept="image/*"
          ...
          <p class="mt-4 text-sm text-gray-500">
            Unterstützte Formate: JPG, PNG, HEIC (max. 10MB)
          </p>
        </div>
      {:else}
        <!-- Preview -->
            ...
            <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
              {#each mealTypes as type}
                <button
                  ...
                  class="rounded-xl px-4 py-3 text-sm font-medium transition-colors {mealType === type.value

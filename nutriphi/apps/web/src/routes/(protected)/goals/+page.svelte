...
<div class="space-y-6">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <div class="h-3 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
          <div
            class="h-full {getProgressColor(getProgressPercent(todayProgress?.calories ?? 0, goals?.calories_target ?? caloriesTarget))} transition-all"
            style="width: {getProgressPercent(todayProgress?.calories ?? 0, goals?.calories_target ?? caloriesTarget)}%"
          ></div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="h-3 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
          <div
            ...
            style="width: {getProgressPercent(todayProgress?.protein ?? 0, goals?.protein_target ?? proteinTarget)}%"
          ></div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="h-3 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
          <div
            ...
            style="width: {getProgressPercent(todayProgress?.carbs ?? 0, goals?.carbs_target ?? carbsTarget)}%"
          ></div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="h-3 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
          <div
            ...
            style="width: {getProgressPercent(todayProgress?.fat ?? 0, goals?.fat_target ?? fatTarget)}%"
          ></div>
        </div>
      </div>
    </div>
  ...
  <div class="rounded-2xl bg-gradient-to-r from-green-500 to-emerald-600 p-6 text-white">
    ...
    <p>
      Die empfohlene tägliche Kalorienzufuhr liegt bei etwa 2000 kcal für Frauen und 2500 kcal für Männer.
      Passe deine Ziele an deine persönlichen Bedürfnisse und Aktivitätslevel an.
    </p>
  </div>
</div>

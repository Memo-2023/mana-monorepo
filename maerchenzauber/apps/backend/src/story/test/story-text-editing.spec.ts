...
describe('StoryController - Text Editing', () => {
  ...
  beforeEach(async () => {
    ...
    ) as jest.Mocked<SupabaseJsonbAuthService>;
    creditClientService = module.get(
      CreditClientService,
    ) as jest.Mocked<CreditClientService>;
  });
  ...
  describe('PUT /story/:id - Text Editing', () => {
    it('should successfully update story text when user owns the story', async () => {
      ...
      expect(supabaseService.getStoryById).toHaveBeenCalledWith(
        'story-123',
        mockToken,
      );
      expect(supabaseService.updateStory).toHaveBeenCalledWith(
        'story-123',
        updateData,
        mockToken,
      );
    ...
    it('should handle database errors gracefully', async () => {
      ...
      supabaseService.getStoryById.mockResolvedValue(mockStory);
      supabaseService.updateStory.mockRejectedValue(
    ...
    it('should update the updated_at timestamp', async () => {
      ...
      supabaseService.getStoryById.mockResolvedValue(mockStory);
      supabaseService.updateStory.mockImplementation(
        async (id, data, token) => {
          return {
            ...mockStory,
            ...data,

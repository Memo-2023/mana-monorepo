...
export const generatePromptStep: PipelineStep<
  CharacterValidationOutput,
  CharacterPromptOutput
> = {
...
function buildStylePrompt(style: string): string {
  const styleGuides: Record<string, string> = {
    photorealistic:
      'ultra-realistic, professional photography, natural lighting',
    ...
    'whimsical illustration':
      "whimsical children's book illustration, friendly, warm colors",
  };

...
export default function CreatorManagement() {
  ...
  const handleCreateOrUpdate = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Erfolg', 
        editingCreator ? 'Creator aktualisiert' : 'Creator erstellt'
      );
  ...
  const handleDelete = async (creator: Creator) => {
    Alert.alert(
      'Creator löschen',
      `Möchtest du "${creator.name}" wirklich löschen?`,
      [
            ...
            <ScrollView style={styles.formScroll} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.typeSelector}>
                  <TouchableOpacity
                    style={[styles.typeButton, formData.type === 'author' && styles.typeButtonActive]}
                    onPress={() => setFormData(prev => ({ ...prev, type: 'author' }))}
                  >
                    <Text style={[styles.typeButtonText, formData.type === 'author' && styles.typeButtonTextActive]}>
                      Autor
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.typeButton, formData.type === 'illustrator' && styles.typeButtonActive]}
                    onPress={() => setFormData(prev => ({ ...prev, type: 'illustrator' }))}
                  >
                    <Text style={[styles.typeButtonText, formData.type === 'illustrator' && styles.typeButtonTextActive]}>
                      Illustrator
                    </Text>
                  </TouchableOpacity>
                </View>
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  placeholder={formData.type === 'author' 
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setFormData(prev => ({ ...prev, extraPromptBeginning: text }))}
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setFormData(prev => ({ ...prev, extraPromptEnd: text }))}

...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Dimensions, RefreshControl, ActivityIndicator, TextInput, Alert, Animated, Platform } from 'react-native';
...
export default function Feedback() {
        ...
        <View style={styles.cardHeader}>
          <View style={styles.voteSection}>
            ...
            >
              <Feather
                name="chevron-up"
                size={20}
                color={item.userHasVoted ? '#FFD700' : '#999'}
              />
          ...
          <View style={styles.cardContent}>
            <Text style={styles.feedbackTitle}>
              {item.title || item.feedbackText.substring(0, 50) + (item.feedbackText.length > 50 ? '...' : '')}
            </Text>
  ...
  const groupedByStatus = feedbackItems.reduce((acc, item) => {
    if (!acc[item.status]) {
      acc[item.status] = [];
    }
  ...
  const statusOrder = ['completed', 'in_progress', 'planned', 'under_review', 'submitted', 'declined'];
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            Teile uns deine Ideen, Wünsche und Verbesserungsvorschläge mit! Wir freuen uns über jedes Feedback.
          </Text>
          ...
          <View style={styles.section}>
            ...
            {myFeedbackExpanded && (
              <View style={styles.collapsibleContent}>
                <Text style={styles.description}>
                  Hier siehst du dein eingereichtes Feedback. Freigegebenes Feedback erscheint in der Community-Liste unten.
                </Text>

...
import { View, StyleSheet, Animated, TouchableOpacity, Platform, Dimensions, Alert, ScrollView, useWindowDimensions } from 'react-native';
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      Toast.show({
        ...
        text2: 'Die Änderungen konnten nicht gespeichert werden. Bei anhaltenden Problemen helfen wir gerne unter support@manacore.ai weiter.',
        position: 'top',
        topOffset: 60,
        visibilityTime: 3000,
      });
    ...
    <View style={styles.outerContainer}>
      ...
      >
        <Text variant="body" color="#fff" style={styles.modalText}>
          Möchtest du "{story?.title}" wirklich archivieren? Die Geschichte wird dann nur noch im Archiv sichtbar sein.
        </Text>
      </Modal>
          ...
          <View style={styles.customHeader}>
            ...
            >
              <Button
                ...
                iconName={isOwnStory ? (isFavorite ? "heart.fill" : "heart") : (userVoted ? "heart.fill" : "heart")}
                iconSet="sf-symbols"
                iconPosition="left"
                variant="tonal"
                size={buttonSize}
                color={isOwnStory ? (isFavorite ? "#FFD700" : "#ffffff") : (userVoted ? "#FFD700" : "#ffffff")}
      ...
      {shouldShowPageNumber && (
        <View style={styles.pageNumberContainer}>
          <Text variant="caption" color="#FFFFFF" style={[styles.pageNumberText, { fontSize: pageNumberFontSize }]}>
...
const styles = StyleSheet.create({
  ...
  blurContainer: {
    ...
    paddingTop: Platform.OS === 'web' ? 16 : Platform.OS === 'ios' ? (() => {

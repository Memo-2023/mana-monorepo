...
import { View, StyleSheet, TextInput, Pressable, ScrollView, ActivityIndicator, Dimensions, Alert } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Redirect, useRouter } from 'expo-router';
import { useAuth } from '../src/contexts/AuthContext';
import Text from '../components/atoms/Text';
import CommonHeader from '../components/molecules/CommonHeader';
import { getStorySystemPrompt, saveStorySystemPrompt, getCharacterSystemPrompt, saveCharacterSystemPrompt } from '../src/services/promptSettings';
...
export default function Prompts() {
  ...
  const [storyPromptSaveStatus, setStoryPromptSaveStatus] = useState<'idle' | 'saving' | 'saved' | 'error'>('idle');
  
  // Character System Prompt State
  const [characterSystemPrompt, setCharacterSystemPrompt] = useState('');
  const [characterPromptSaveStatus, setCharacterPromptSaveStatus] = useState<'idle' | 'saving' | 'saved' | 'error'>('idle');
  ...
  const handleGenerateStory = async () => {
    ...
    try {
      ...
      setStoryError(error instanceof Error ? error.message : 'Ein unerwarteter Fehler ist aufgetreten');
  ...
  const handleGenerateCharacter = async (prompt: string, name: string) => {
    ...
    try {
      ...
      setCharacterError(error instanceof Error ? error.message : 'Ein unerwarteter Fehler ist aufgetreten');
            ...
            <View style={styles.container}>
              <View style={styles.section}>
                ...
                <Text style={styles.description}>
                  Dieser Prompt wird verwendet, um den Stil der generierten Geschichten zu definieren.
                </Text>
                <TextInput
                  style={styles.input}
                ...
                >
                  <Text style={styles.saveButtonText}>
                    {getButtonText(storyPromptSaveStatus)}
                  </Text>
                </Pressable>
              </View>
                ...
                {generatedStory && (
                  <View style={styles.resultContainer}>
                    <View style={styles.promptInfo}>
                      ...
                      <Text style={[styles.promptLabel, styles.topSpacing]}>Generierte Geschichte:</Text>
                    </View>
          ...
          <ScrollView>
            <View style={styles.container}>
              <View style={styles.section}>
                ...
                <Text style={styles.description}>
                  Dieser Prompt wird verwendet, um den Stil der generierten Charaktere zu definieren.
                </Text>
                <TextInput
                  style={styles.input}
                ...
                {generatedCharacter && (
                  <View style={styles.resultContainer}>
                    <View style={styles.promptInfo}>
                      ...
                      <Text style={[styles.promptLabel, styles.topSpacing]}>Generierter Charakter:</Text>
                    </View>
                    ...
                    <View style={styles.characterInfo}>
                      ...
                      <Text style={[styles.characterLabel, styles.topSpacing]}>Charakter & Persönlichkeit:</Text>
                      <Text style={styles.characterText}>{generatedCharacter.personality}</Text>
                      
                      <Text style={[styles.characterLabel, styles.topSpacing]}>Motivation & Ziele:</Text>
                      <Text style={styles.characterText}>{generatedCharacter.motivation}</Text>
                      
                      <Text style={[styles.characterLabel, styles.topSpacing]}>Geschichte & Hintergrund:</Text>
                      <Text style={styles.characterText}>{generatedCharacter.background}</Text>
                      
                      <Text style={[styles.characterLabel, styles.topSpacing]}>Beziehungen & Verbindungen:</Text>
                      <Text style={styles.characterText}>{generatedCharacter.relationships}</Text>
                      
                      <Text style={[styles.characterLabel, styles.topSpacing]}>Entwicklung & Potenzial:</Text>
                      <Text style={styles.characterText}>{generatedCharacter.development}</Text>

                      <Text style={[styles.characterLabel, styles.topSpacing]}>Erscheinungsbild:</Text>

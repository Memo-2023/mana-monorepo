...
import { View, StyleSheet, Image as RNImage, Animated, TextInput, ScrollView, useWindowDimensions } from 'react-native';
...
export default function StartScreen({ title, characterName, isEditMode = false, onTitleChange, onCancelEdit, onSaveEdit }: StartScreenProps) {
        ...
        {!isEditMode && (
          <>
            <Animated.View style={[
              ...
              <Text variant="header" color="#FFFFFF" style={[styles.title, { fontSize: titleFontSize, lineHeight: titleLineHeight, minHeight: titleLineHeight }]}>
                {localTitle}
              </Text>

              <View style={styles.subtitleContainer}>
                {characterName && (
                  <Text variant="subheader" color="#FFFFFF" style={[styles.subtitle, { fontSize: subtitleFontSize }]}>

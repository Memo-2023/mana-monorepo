...
export const GoogleSignInButton: React.FC = () => {
  ...
  useEffect(() => {
    ...
    GoogleSignin.configure({
      webClientId: process.env.EXPO_PUBLIC_GOOGLE_CLIENT_ID || '111768794939-uu9b50hlh1mmsd1v8pdm4s58o04lqh22.apps.googleusercontent.com',
      iosClientId: iosClientId || '111768794939-dtmimmtn6op11a39bo1v4o7et4h913dd.apps.googleusercontent.com',

...
export default function ManaCounter({
  onPress,
  size = 'medium'
}: ManaCounterProps) {
  ...
  const sizeConfig = {
    small: { iconSize: 16, fontSize: 13, paddingVertical: 6, paddingLeft: 6, paddingRight: 12, minWidth: 60 },
    medium: { iconSize: 22, fontSize: 16, paddingVertical: 8, paddingLeft: 8, paddingRight: 16, minWidth: 70 },
    large: { iconSize: 26, fontSize: 20, paddingVertical: 10, paddingLeft: 10, paddingRight: 18, minWidth: 80 },
  };

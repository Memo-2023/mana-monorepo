...
import { Modal as RNModal, View, StyleSheet, TouchableOpacity, ModalProps as RNModalProps } from 'react-native';
    ...
    >
      ...
      >
        <TouchableOpacity activeOpacity={1} onPress={(e) => e.stopPropagation()}>
          {useBlur ? (
            <BlurView intensity={blurIntensity} tint="dark" style={[styles.modalBlur, { maxWidth }]}>

...
export const MOCK_TOKENS = {
  VALID_APP_TOKEN: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwiZW1haWwiOiJ0ZXN0QGV4YW1wbGUuY29tIiwicm9sZSI6InVzZXIiLCJhcHBfaWQiOiJ0ZXN0LWFwcC1pZCIsImV4cCI6OTk5OTk5OTk5OSwiaWF0IjoxNjEwMDAwMDAwfQ.fake-signature',
  EXPIRED_APP_TOKEN: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwiZW1haWwiOiJ0ZXN0QGV4YW1wbGUuY29tIiwicm9sZSI6InVzZXIiLCJhcHBfaWQiOiJ0ZXN0LWFwcC1pZCIsImV4cCI6MTYxMDAwMDAwMCwiaWF0IjoxNjEwMDAwMDAwfQ.fake-signature',
...
export const mockFetchResponses = {
  signInSuccess: () => MockResponseBuilder.success({
  ...
  refreshTokenSuccess: () => MockResponseBuilder.success({
    appToken: MOCK_TOKENS.VALID_APP_TOKEN,
    refreshToken: MOCK_TOKENS.VALID_REFRESH_TOKEN,
    userData: {

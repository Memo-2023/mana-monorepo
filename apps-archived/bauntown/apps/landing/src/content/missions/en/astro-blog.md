	...
	<section class="about">
		...
		<div class="about-content">
			...
			<div class="about-text">
				<p>
					Hello! I'm [Your Name], a passionate web developer with an interest in modern technologies
					and frameworks.
				</p>

				<p>
					I created this blog to document my learning experiences and projects. I mainly write
					about:
				</p>
				...
				<p>If you have any questions or want to get in touch, you can find me on:</p>

...
Alle Font Awesome Icons ersetzt durch astro-icon: ✅ fas fa-rocket → mdi:rocket ✅ fas fa-sliders-h
→ mdi:tune ✅ fas fa-lightbulb → mdi:lightbulb ✅ fas fa-plug → mdi:power-plug ✅ fas
...
```html
✅ Plausible: defer attribut vorhanden ✅ PostHog: async loading ✅ DNS-prefetch für externe Domains
```

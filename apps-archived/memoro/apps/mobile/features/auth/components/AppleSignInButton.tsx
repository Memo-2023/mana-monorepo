	...
	const signInWithApple = async () => {
		...
		try {
			...
			if (userData) {
				...
				try {
					const { initializeRevenueCatConditionally, identifyRevenueCatUser } = await import(
						'~/features/subscription/revenueCatManager'
					);
			...
			>
				<View style={styles.buttonContent}>
					<View style={styles.appleIconContainer}>
						<AntDesign name="apple1" size={20} color={isDark ? '#ffffff' : '#000000'} />
					</View>

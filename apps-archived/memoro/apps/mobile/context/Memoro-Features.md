...
Optionale Standortspeicherung: Wenn in den Einstellungen aktiviert, wird zustäzlich automatisch der Standort beim Beenden der Memo gespeichert. Dieser kann dann auf der Karte angesehen werden.
...
20 Express-Sprachen: Diese Sprachen können in wenigen Sekunden verarbeitet werden, und stehen unmittelbar zur Verfügung. Wirft verwendet bei Aufnahmen bis zu 40 Minuten. Unterstützte Sprachen: Deutsch, Englisch, Französisch, Spanisch, Italienisch, Niederländisch, Polnisch, Schwedisch, Russisch, Portugiesisch, Arabisch, Hindi, Chinesisch, Japanisch, Koreanisch.
...
Dialekt-Erkennung: Memoro unterstützt verschiedenste Dialekte, um eine möglichst gute Transkriptions Qualität zu gewährleisten. Diese Varianten werden unterstützt: Regionales Deutsch (Deutschland, Österreich, Schweiz), Englisch-Varianten (USA, UK, Australien, Indien), Spanisch-Dialekte (Spanien, Mexiko, Argentinien, Kolumbien), Chinesische Varianten (Mandarin, Kantonesisch, Taiwanesisch)
...
Beschreibung: Ihre persönliche Audiobibliothek - alle Aufnahmen sicher gespeichert und jederzeit verfügbar
Hauptfunktionen:

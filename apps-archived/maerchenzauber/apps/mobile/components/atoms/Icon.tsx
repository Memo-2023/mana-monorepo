	...
	const renderIcon = () => {
		...
		switch (set) {
			case 'ionicons':
				return (
					<Ionicons
						name={(props as IoniconsIconProps).name}
						size={size}
						color={color}
						style={style}
					/>
			...
			case 'fontawesome':
				return (
					<FontAwesome
						name={(props as FontAwesomeIconProps).name}
						size={size}
						color={color}
						style={style}
					/>
			...
			case 'fontawesome5':
				return (
					<FontAwesome5
						name={(props as FontAwesome5IconProps).name}
						size={size}
						color={color}
						style={style}
					/>
			...
			case 'antdesign':
				return (
					<AntDesign
						name={(props as AntDesignIconProps).name}
						size={size}
						color={color}
						style={style}
					/>
			...
			case 'materialcommunity':
				return (
					<MaterialCommunityIcons
						name={(props as MaterialCommunityIconProps).name}
						size={size}
						color={color}
						style={style}
					/>
			...
			default:
				return (
					<MaterialIcons
						name={(props as MaterialIconProps).name}
						size={size}
						color={color}
						style={style}
					/>

...
export default function StoryPage({
	...
	if (isWideLayout) {
		...
		imageWidth = isTablet ? Math.min(600, availableWidth) : Math.min(400, availableWidth);
		imageHeight = imageWidth * (4 / 3); // 3:4 aspect ratio (portrait)
	}
					...
					{isTextOnLeft ? (
						<>
							...
							<View style={styles.landscapeTextContainer}>
								<Text variant="body" color="#FFFFFF" style={styles.textWide}>
									{localText}
								</Text>
							</View>
							{/* Image Right */}
						...
						<View style={[styles.textWrapper, { marginTop: imageSpacing }]}>
							{isTablet ? (
								...
								<View style={styles.textTabletContainer}>
									<Text variant="body" color="#FFFFFF" style={styles.textTablet}>
										{localText}
									</Text>
								</View>
							) : (
					...
					<View style={[styles.editOverlayContent, { width: imageWidth, height: imageHeight }]}>
						...
						>
							<TextInput
								...
								multiline
								style={[styles.editOverlayInput, isTablet && styles.textTablet]}

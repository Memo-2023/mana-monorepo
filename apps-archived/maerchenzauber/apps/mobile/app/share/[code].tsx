		...
		<SafeAreaView style={styles.safeArea} edges={['top']}>
			...
			<View style={styles.container}>
				<View style={styles.characterCard}>
					<Avatar imageUrl={character?.image_url} name={character?.name} size={180} />
					<Text style={styles.characterName}>{character?.name}</Text>
					<Text style={styles.characterDescription}>{character?.original_description}</Text>

					<View style={styles.shareInfo}>
						<Text style={styles.shareCode}>Share-Code: {code}</Text>
						<Text style={styles.sharedBy}>Geteilt von einem Freund</Text>
					</View>
				</View>

...
export const HARDCODED_CHARACTERS: (Character & { id: string; isFeatured: boolean })[] = [
	{
		...
		name: 'Finia',
		originalDescription:
			'Eine Mutter weibliche Füchsin, mit rot goldenem Fell. Sie hat einen großen Fuchsschwanz der rot golden lodert, wie Flammen mit Magie. Sie sieht weise, ruhig und gelassen aus. Sie hat ein grünes Halstuch an.',
		characterDescriptionPrompt:
			'A wise mother fox with red-golden fur. She has a large fox tail that glows red-gold like flames with magic. She appears wise, calm and composed. She wears a green neckerchief. Mystical and nurturing appearance.',
		images: [
			{

...
export const createMarkdownStyles = (theme: {
  ...
  blockquote: {
    borderLeftWidth: 3,
    borderLeftColor: theme.accentColor || (theme.isDark ? 'rgba(255,255,255,0.3)' : 'rgba(0,0,0,0.3)'),
    paddingLeft: 12,
    paddingVertical: 8,
    marginVertical: 8,
...
export const createCompactMarkdownStyles = (baseStyles: ReturnType<typeof createMarkdownStyles>) => ({
  ...baseStyles,
  body: {
    ...baseStyles.body,
    fontSize: 16,

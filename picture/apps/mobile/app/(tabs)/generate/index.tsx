            ...
            <View className="space-y-6">
              ...
              {activeTab === 'builder' && (
                <>
                  {/* Model Selection */}
                  <View>
                    <Text variant="label" color="secondary" className="mb-2" style={{ opacity: 0.7, fontSize: 13 }}>
                      Modell
                    </Text>
                    <ModelSelector
                      models={models}
                  ...
                  {showAdvanced && (
                    <View style={{
                      ...
                      {/* Technical Details */}
                      <View style={{ paddingTop: 12, borderTopWidth: 1, borderTopColor: theme.colors.border }}>
                        <Text variant="bodySmall" color="secondary" className="mb-2">
                          Technische Details
                        </Text>
                        <View className="space-y-2">
                          <View className="flex-row justify-between items-center py-2">
                            <Text variant="body" color="tertiary">Bildgröße</Text>
                            <Text variant="body" color="primary" weight="medium">{width} × {height}</Text>
                          </View>
                          <View className="flex-row justify-between items-center py-2">
                            <Text variant="body" color="tertiary">Steps</Text>
                            <Text variant="body" color="primary" weight="medium">{steps}</Text>
                          </View>
                          <View className="flex-row justify-between items-center py-2">
                            <Text variant="body" color="tertiary">Guidance Scale</Text>
                            <Text variant="body" color="primary" weight="medium">{guidanceScale}</Text>
                          </View>
                        </View>
                      </View>
                    </View>

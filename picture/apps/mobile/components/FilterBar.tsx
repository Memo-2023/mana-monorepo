          ...
          >
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 12 }}>
                {/* Favorites Pill */}
                <Pressable
                  onPress={() => onFilterModeChange(filterMode === 'favorites' ? 'all' : 'favorites')}
                  style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                    ...
                    borderRadius: 999,
                    borderWidth: 2,
                    borderColor: filterMode === 'favorites' ? theme.colors.primary.default : PlatformColor('separatorColor'),
                    backgroundColor: filterMode === 'favorites' ? theme.colors.primary.default : 'transparent',
                    marginRight: 8,
                  }}
                >
                  <Ionicons
                    ...
                    style={{ marginRight: 6 }}
                  />
                  <Text style={{ color: filterMode === 'favorites' ? 'white' : PlatformColor('labelColor'), fontSize: 14, fontWeight: '600' }}>
                    Favoriten
                  </Text>
                </Pressable>
